            ...
            hbox spacing 14:
                ...
                vbox spacing 6:
                    ...
                    imagebutton:
                        ...
                        action [ Function(gm.windows.hide, "punish"), Call("call_label", "amy_punish") ]

                    text "Cassandra" style "menu_text"
                    imagebutton:
                        auto "punish_image_cass_%s"
                        action [ Function(gm.windows.hide, "punish"), Call("call_label", "cass_punish") ]
                ...
                vbox spacing 6:
                    ...
                    imagebutton:
                        ...
                        action [ Function(gm.windows.hide, "punish"), Call("call_label", "debbie_punish") ]

                    text "Rachel" style "menu_text"
                    imagebutton:
                        auto "punish_image_rachel_%s"
                        action [ Function(gm.windows.hide, "punish"), Call("call_label", "rachel_punish") ]
